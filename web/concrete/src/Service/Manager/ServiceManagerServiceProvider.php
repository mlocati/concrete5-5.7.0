...
class ServiceManagerServiceProvider extends \Concrete\Core\Foundation\Service\Provider
{
    ...
    {
        $this->app->singleton('Concrete\Core\Service\Manager\ServiceManager');
        $this->app->bind('Concrete\Core\Service\Manager\ManagerInterface', 'Concrete\Core\Service\Manager\ServiceManager');
        $this->app->bind('Concrete\Core\Service\Manager\ServiceManager', function(Application $app) {
